...
static const char *item_text_map[] =
{
  ...
  "I_PORTS",
  "I_GENERICS", "I_PARAMS",    "I_GENMAPS",  "I_WAVES",
  "I_CONDS",
  "I_TYPE",     "I_SUBKIND",   "I_DELAY",    "I_REJECT",
  "I_POS",
  "I_REF",      "I_FILE_MODE", "I_ASSOCS",   "I_CONTEXT",
  "I_TRIGGERS",
  "I_ELSES",    "I_CLASS",     "I_RANGE",    "I_NAME",
  "I_NETS",
  "I_DVAL",     "I_SPEC",      "I_OPS",      "I_CONSTR",
  "I_BASE",
  "I_ELEM",     "I_FILE",      "I_ACCESS",   "I_RESOLUTION",
  "I_RESULT",
  "I_UNITS",    "I_LITERALS",  "I_DIMS",     "I_FIELDS",
  "I_TEXT_BUF",
  "I_ATTRS",    "I_PTYPES",    "I_CHARS",    "I_CONSTR2",
  "I_FLAGS",
  "I_TEXT",
};
...
object_copy_mark (
  ...
  if (type_item != -1) {
    marked =
      object_copy_mark((object_t *) object->items[type_item].type, ctx) ||
      marked;
  }
