...
static void p_interface_declaration(class_t def_class, tree_t parent, add_func_t addf);
static void p_interface_element(class_t def_class, tree_t parent, add_func_t addf);
...
static void
p_architecture_declarative_part (
  tree_t arch
) {
...
static tree_t
p_component_instantiation_statement (
  ident_t label
) {
...
static tree_t
p_concurrent_assertion_statement (
  ident_t label
) {
...
static tree_t
p_concurrent_procedure_call_statement (
  ident_t label
) {
...
static void
p_configuration_declarative_part (
  tree_t unit
) {
...
static type_t
p_constrained_array_definition (
  void
) {
...
static void
p_package_body_declarative_item (
  tree_t parent
) {
  // subprogram_declaration | subprogram_body | type_declaration
...
static void
p_package_body_declarative_part (
  tree_t unit
) {
...
static void
p_protected_type_body_declarative_item (
  tree_t body
) {
  // subprogram_declaration | subprogram_body | type_declaration
  //   | subtype_declaration | constant_declaration | variable_declaration
...
static void
p_protected_type_body_declarative_part (
  tree_t body
) {
...
static void
p_protected_type_declarative_item (
  type_t type
) {
...
static void
p_protected_type_declarative_part (
  type_t type
) {
...
static type_t
p_unconstrained_array_definition (
  void
) {
...
static tree_t
p_variable_assignment_statement (
  ident_t label,
  tree_t  name
) {
...
token_str (
  ...
  {
    "end of file",   "identifier", "entity",        "is",
    "end",
    "generic",       "port",
    "constant",      "component",  "configuration",
    "architecture",
    "of",
    "begin",
    "for",           "type",       "to",            "all",
    ...
    "out",           "buffer",     "bus",
    "unaffected",
    "signal",        "downto",     "process",
    "postponed",
    "wait",
    "report",        "(",          ")",
    ";",             ":=",         ":",             ",",
    "integer",
    "string",        "error",      "inout",         "linkage",
    "variable",      "if",         "range",         "subtype",
    "units",
    "package",       "library",
    "use",           ".",          "null",          "'",
    "function",
    "impure",        "return",     "pure",          "array",
    "<>",            "=>",         "others",        "assert",
    "severity",
    "on",            "map",        "then",          "else",
    "elsif",         "body",       "while",         "loop",
    "after",
    "alias",         "attribute",
    "procedure",     "exit",       "next",          "when",
    "case",
    "label",         "group",      "literal",
    "|",             "[",          "]",
    "inertial",
    "transport",     "reject",     "bit string",    "block",
    "with",          "select",     "generate",      "access",
    "file",
    "open",          "real",       "until",
    "record",        "new",        "shared",        "and",
    "or",
    "nand",          "nor",        "xor",           "xnor",
    "=",             "/=",         "<",             "<=",
    ">",
    ...
    "rem",           "abs",        "not",           "*",
    "guarded",
    "reverse_range", "protected",  "context",       "`if",
    "`else",
    "`elsif",        "`end",
    "`error",        "`warning",   "translate_off",
    "translate_on",
    "pragma"
  };
